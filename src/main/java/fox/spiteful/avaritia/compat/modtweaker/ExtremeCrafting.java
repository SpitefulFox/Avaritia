package fox.spiteful.avaritia.compat.modtweaker;
...
public class ExtremeCrafting {
    ...
    @ZenMethod
    public void remove(IItemStack target){
    ...
    private static class Remove implements IUndoableAction {
        ...
        @Override
        public String describe(){
            return "Removing Xtreme Crafting Recipe for " + recipe.getRecipeOutput().getDisplayName();
        }

        @Override
        public String describeUndo(){
            return "Un-removing Xtreme Crafting Recipe for " + recipe.getRecipeOutput().getDisplayName();
        }
