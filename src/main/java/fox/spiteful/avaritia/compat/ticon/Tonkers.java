...
public class Tonkers {
	...
	public static void buildstruct() {
		...
		infinityMetal = new Material(infinityMetalName, "material." + infinityMetalName, 5, 10000, 6000, 50, 10.0f, 10, 0.0f, LudicrousItems.cosmic.rarityColor.toString(), 0xFFFFFF);
