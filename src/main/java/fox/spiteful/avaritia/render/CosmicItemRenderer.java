...
//
//                    CosmicShaderHelper.cosmicOpacity = icri.getMaskOpacity(item, null);
...
//            ICosmicRenderItem icri = (ICosmicRenderItem) (item.getItem());
//            CosmicShaderHelper.cosmicOpacity = icri.getMaskOpacity(item, player);
//            CosmicShaderHelper.useShader();
//
...
//                if (ent != null) {
//                    CosmicShaderHelper.setLightFromLocation(ent.worldObj, MathHelper.floor_double(ent.posX), MathHelper.floor_double(ent.posY), MathHelper.floor_double(ent.posZ));
//                }
//                break;
//            }
//            case EQUIPPED: {
