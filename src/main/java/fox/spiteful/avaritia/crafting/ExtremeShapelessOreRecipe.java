...
public class ExtremeShapelessOreRecipe implements IRecipe
{
    ...
    public ExtremeShapelessOreRecipe(Block result, Object... recipe){ this(new ItemStack(result), recipe); }
    public ExtremeShapelessOreRecipe(Item  result, Object... recipe){ this(new ItemStack(result), recipe); }
