...
public class ExtremeShapedOreRecipe implements IRecipe {
    ...
    public ExtremeShapedOreRecipe(Block result, Object... recipe){ this(new ItemStack(result), recipe); }
    public ExtremeShapedOreRecipe(Item result, Object... recipe){ this(new ItemStack(result), recipe); }
